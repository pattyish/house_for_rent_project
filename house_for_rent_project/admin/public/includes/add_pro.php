...
<label for="" class="control-label">Price<span style="color:red; font-size:20px;">&nbsp;<strong>*</strong></span></label>
  <input type="number" class="form-number required form-control"  placeholder="" required="required" aria-required="true">
    <div class="checkbox form-group" style="padding-top:5px; color:green; padding-bottom:5px;"><label><input type="checkbox" class="checkbox">&nbsp;&nbsp; is price negotiable?</label> </div>
...
<label for="">Outdoor BathRooms<span style="color:red; font-size:20px;">&nbsp;<strong>*</strong></span></label>
  <input type="number" class=" form-control"  placeholder="" required="required" aria-required="true">
    </div>
              </div>
</fieldset>
              </div>
   ...
   <div class="checkbox form-group" style="padding-top:5px; padding-bottom:5px;">
    <label><input type="checkbox" class=""> swimming pool</label>
    <label><input type="checkbox" class=""> Loundry</label>
    <label><input type="checkbox"  class=""> Window covering</label>
  </div>
  <div class="checkbox form-group" style="padding-top:5px; padding-bottom:5px;">
    <label><input type="checkbox" class=""> swimming pool</label>
    <label><input type="checkbox" class=""> Loundry</label>
