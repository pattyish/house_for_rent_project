...
<div class="clearfix"> </div> 
    <div class="container" style="padding-bottom:90px;">
        ...
        <li><a href=""><i class="fa fa-user"></i> Account</a></li>
            <li><a href="/login_for_adverter"><span class="glyphicon glyphicon-log-in"></span>&nbsp;Login</a></li>
      </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
                ...
                <a href="/login_for_adverter" style="font-family:;" class="btn btn-block btn-primary ">Login </a>
            </div>
            </div>
            <div class="col-lg-6">
