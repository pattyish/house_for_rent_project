 ...
 .nav-pills ul li{
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header" style="padding-top:8px;">
      ...
      <a class="navbar-brand" href="index.php" style="font-size:35px;font-family:pristina; color:#fff; font-style:italic; font-weight:bold;"><strong>HOUSE</strong>&nbsp;<small style=
      "color:orange;font-size:16px;">MAJOR</small></a>
      </div>
    <div class="nav navbar-nav navbar-right">
        <div style="padding-top:16px; padding-bottom:16px; padding-right:30px;"><h4>Welcome <span style="color: orange;">Ngizwenayo Edson</span></h4></div>
